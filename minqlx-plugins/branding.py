...
class branding(minqlx.Plugin):
    def __init__(self):
        ...
        self.set_cvar_once("qlx_brandingAppendMapName", "0")
    ...
    def brand_map(self):
        ...
        elif self.get_cvar("qlx_brandingAppendMapName", bool):
            topBranding = self.get_cvar("qlx_serverBrandName") + " ^7- " + self.game.map_title
        else:
            topBranding = self.get_cvar("qlx_serverBrandName")
        if self.get_cvar("qlx_brandingAppendGameType", bool):
            topBranding =  topBranding + " ^7- " + self.game.type
